...
namespace Revit.Async
{
    ...
    public class RevitTask : IRevitTask
    {
        ...
        /// <summary>
        ///     Raise an <see cref="IGenericExternalEventHandler{TParameter,TResult}" /> and get the message.
        ...
        ///     The type of message that <see cref="IGenericExternalEventHandler{TParameter,TResult}" />
        ///     generates
        /// </typeparam>
        /// <param name="parameter">
        ///     The parameter passed to the <see cref="IGenericExternalEventHandler{TParameter,TResult}" />
        /// </param>
        /// <returns>The message generated by <see cref="IGenericExternalEventHandler{TParameter,TResult}" /></returns>
        ...
        /// <summary>
        ///     Running Revit API code and get the message asynchronously
        /// </summary>
