...
namespace Revit.Async.Extensions
{
    ...
    public static class ExternalEventResultHandlerExtensions
    {
        ...
        /// </summary>
        /// <typeparam name="TSource">The type of the task message to wait</typeparam>
        /// <typeparam name="TResult">The type of the message to generate</typeparam>
        /// <param name="resultHandler">The instance of handler to handle the message</param>
